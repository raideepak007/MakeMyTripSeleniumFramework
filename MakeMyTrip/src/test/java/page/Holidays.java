...
public class Holidays {
	...
	public static WebElement holidays(WebDriver driver) {
		element = driver.findElement(By.xpath("//span[text()='Holidays']"));
		return element;
	}
	
	public static WebElement from(WebDriver driver) {
		element = driver.findElement(By.xpath("//span[@data-cy='fromCity']"));
		return element;
	}
	...
	public static WebElement to(WebDriver driver) {
		element = driver.findElement(By.xpath("//input[@id='toCity']"));
		return element;
	}
